  ...
  return (
    <main className="flex-grow flex container flex-col space-y-4">
      ...
      <h2 className="text-muted-foreground text-xl">
        Email me, or schedule a chat
      </h2>

      <p>
        I live in Adelaide, Australia which has a timezone of GMT+9:30 or
        GMT+10:30 in the Southern Hemisphere Summer.
        <br />
        You can email me at{" "}
        <a href="mailto:hello@joshuasteele.net" className="underline">
          hello@joshuasteele.net
        </a>{" "}
