        ...
        onClick={() => {
          if (window.Calendly) {
            ...
            Calendly.initPopupWidget({
              url: `https://calendly.com/hello-joshuasteele/30min?hide_event_type_details=1&background_color=${backgroundColor}&text_color=${textColor}&primary_color=7c3aed`,
            });
          }
        }}
        size={"default"}
        className="w-min space-x-2"
      >
